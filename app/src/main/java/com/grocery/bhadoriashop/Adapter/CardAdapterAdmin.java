...
public class CardAdapterAdmin extends RecyclerView.Adapter<CardAdapterAdmin.PlanetHolder> {

    private Context context;
    private ArrayList<Planet> planets;

    public CardAdapterAdmin(Context context, ArrayList<Planet> planets) {
